@theme @theme_ccot
Feature: the editor hint toggle should be ignored by ccot in Blackboard Open LMS 2.9
  ...
  Background:
    Given the following config values are set as admin:
      | theme_ccot_disableeditorhints | true |
  ...
  @javascript
  Scenario: Create a URL resource in ccot theme
