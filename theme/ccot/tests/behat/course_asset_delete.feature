...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can delete course resources and activities without having to reload the page.
  ...
  Scenario: In read mode, on front page, admin can cancel / confirm delete activity.
    ...
    When I click on ".ccot-activity[data-type='Assignment'] a.ccot-edit-asset-more" "css_element"
    And I click on ".ccot-activity[data-type='Assignment'] a.js_ccot_delete" "css_element"
  ...
  Scenario: Student cannot delete activity.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then ".ccot-activity[data-type='Assignment'] a.ccot-edit-asset-more" "css_element" should not exist
    And ".ccot-activity[data-type='Assignment'] a.js_ccot_delete" "css_element" should not exist
