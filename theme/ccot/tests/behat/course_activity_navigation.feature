...
@theme @theme_ccot
Feature: Activity navigation in ccot theme
  ...
  Background:
    ...
    # Hidden activity.
    And I click on ".ccot-activity[data-type='Glossary'] a.ccot-edit-asset-more" "css_element"
    And I click on ".ccot-activity[data-type='Glossary'] a.js_ccot_hide" "css_element"
    # Hidden section.
    And I follow "Topic 5"
    And I wait until the page is ready
    And I click on "#section-5 a.ccot-visibility.ccot-hide" "css_element"
    # Set up book.
  ...
  Scenario: Resources with visible description have a different class
    ...
    And I wait until the page is ready
    And I check element ".modtype_url" has class "ccot-resource"
    And I follow "Edit \"Url 1\""
    And I expand all fieldsets
    And I set the field "Display description on course page" to "1"
    And I press "Save and return to course"
    And I check element ".modtype_url" has class "ccot-extended-resource"
