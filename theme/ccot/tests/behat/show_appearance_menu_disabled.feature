...
#
# Tests for ccot on a page resource.
#
# @package    theme_ccot
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot and there is a page resource, appearance options should not appear.
  ...
  @javascript
  Scenario: Page description checkbox is not shown when using ccot.
    Given I log in as "teacher1"
    And I am on the course main page for "C1"
    Then I click on "//a[@class='ccot-edit-asset']" "xpath_element"
  ...
  Scenario: Teacher sees a warning message and is unable to choose any appearance options on page resource.
    ...
    And I should see "ccot's design language prevents changes to \"Appearance\" settings."
