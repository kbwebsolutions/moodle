...
#
# Tests for course progress in the ccot personal menu.
#
# @package    theme_ccot
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, students and teachers can open a personal menu which features a
