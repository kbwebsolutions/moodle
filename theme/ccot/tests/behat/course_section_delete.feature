...
#
# Tests deleting sections in ccot.
#
# @package    theme_ccot
# @author     Guy Thomas
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can delete sections without having to reload the page.
  ...
  Scenario: In read mode, on course, teacher can cancel / confirm delete section.
    ...
    When I click on "#section-1 .ccot-section-editing.actions a.ccot-delete" "css_element"
  ...
  Scenario: Student cannot delete section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then "#section-1 .ccot-section-editing.actions a.ccot-delete" "css_element" should not exist
