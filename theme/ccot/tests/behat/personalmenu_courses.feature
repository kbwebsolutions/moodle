...
#
# Tests for courses in the ccot personal menu.
#
# @package    theme_ccot
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, students and teachers can open a personal menu with a list of courses
