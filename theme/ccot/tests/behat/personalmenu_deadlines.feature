...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, students and teachers can find in their personal menu a list of deadlines
  ...
  Scenario: Student sees correct submission status against deadlines when 1 out of 2 assignments are submitted by student.
    ...
    And I should see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:first-of-type" "css_element"
    And I should see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:nth-of-type(2)" "css_element"
    ...
    And I open the personal menu
    And I should see "Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:first-of-type" "css_element"
    And I should not see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:first-of-type" "css_element"
    And I should see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:nth-of-type(2)" "css_element"
  ...
  Scenario: Teacher sees no submission status data against deadlines.
    ...
    And I open the personal menu
    And I should not see "Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:first-of-type" "css_element"
    And I should not see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:first-of-type" "css_element"
    And I should not see "Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:nth-of-type(2)" "css_element"
    And I should not see "Not Submitted" in the "#ccot-personal-menu-deadlines div.ccot-media-object:nth-of-type(2)" "css_element"

  @javascript
  Scenario: Student sees correct submission status when the platform theme is different from ccot and the course is forced to ccot
    Given the following config values are set as admin:
      | theme | clean |
    Given the following "activities" exist:
      | activity | course | idnumber | name             | intro             | assignsubmission_onlinetext_enabled | assignfeedback_comments_enabled | section | duedate                      |
