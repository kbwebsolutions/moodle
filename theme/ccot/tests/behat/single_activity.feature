...
#
# Tests that Single Activity format remains usable in ccot
#
# @package   theme_ccot
# @author    Sam Chaffee
...
@theme @theme_ccot
Feature: Use the Single Activity format in ccot
  In order to use the Single Activity format in ccot
  As a teacher
  I need to be able to create a course using Single Activity format without errors in ccot
  ...
  Scenario: Admin creates a single activity course with a Glossary
    ...
    And I set the following fields to these values:
      | Course full name | Test single activity in ccot|
