...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, and global search is enabled, users should see a global search interface.
  ...
  Scenario: Non-logged in user sees search interface.
    ...
    Then ".ccot-login-button" "css_element" should exist
