...
#
# Tests for toggle course section highlighting in non edit mode in ccot.
#
# @package    theme_ccot
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can toggle the currently higlighted course sections.
  ...
  Scenario: In read mode, teacher toggles section as current and student sees appropriate status.
    ...
    And I wait until "#section-2 .ccot-highlight" "css_element" exists
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 2"
    Given I click on "#section-2 .ccot-highlight" "css_element"
    And I wait until "#section-2 .ccot-highlight" "css_element" exists
  ...
  highlight section.
    ...
    And I click on "#section-1 .ccot-highlight" "css_element"
  ...
  Scenario: Student cannot mark section current.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 2"
    Then "#section-2 .ccot-highlight" "css_element" should not exist
