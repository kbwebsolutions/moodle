...
#
# Tests for single section to be overriden with normal behaviour in ccot.
#
# @package    theme_ccot
...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, courses in single section per page mode are forced to operate with all
