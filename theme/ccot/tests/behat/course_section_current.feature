...
@theme @theme_ccot
Feature: Entering a ccot course without specifying a section will take you to the current section
  ...
  Scenario: Once a topic is highlighted, that section is shown on entering the course
    ...
    And I am on the course main page for "C1"
    Then I should see "Introduction" in the ".section.state-visible" "css_element"
    And "#chapters li:nth-of-type(1).ccot-visible-section" "css_element" should exist
    And I follow "Topic 1"
    And I highlight section 1
    And I am on the course main page for "C1"
    And I should see "Untitled Topic" in the ".section.state-visible" "css_element"
    And "#chapters li:nth-of-type(2).ccot-visible-section" "css_element" should exist
