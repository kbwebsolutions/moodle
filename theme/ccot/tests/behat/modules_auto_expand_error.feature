...
@theme @theme_ccot
Feature: When setting an erroneous field in settings, ccot auto-expands area.
  ...
  Scenario: Go to Assignment settings page and put wrong max grade.
    ...
    And I click on ".ccot-activity[data-type='Assignment']  a.ccot-edit-asset" "css_element"
