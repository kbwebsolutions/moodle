...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can move course sections without using drag and drop and without
  ...
  Scenario: In read mode, teacher moves section 1 before section 4 (section 3).
    ...
    Then I should see "Moving \"My & < > Topic\"" in the "#ccot-footer-alert" "css_element"
    ...
    And "#chapters li:nth-of-type(4).ccot-visible-section" "css_element" should exist
