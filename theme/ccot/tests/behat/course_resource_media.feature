...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, clicking on a resource with a media file mime type will open the
  resource inline.
  ...
  Scenario: MP3 opens inline and marked as completed.
    ...
    Then ".ccot-resource[data-type='mp3']" "css_element" should exist
    Then ".ccot-resource[data-type='mp3']" "css_element" should exist
    And I click on ".ccot-edit-asset" "css_element"
    ...
    And I click on ".ccot-resource[data-type='mp3'] .ccot-asset-link a" "css_element"
    And I wait until "#ccot-light-box" "css_element" is visible
   Then "#ccot-light-box" "css_element" should exist
    And I click on "#ccot-light-box-close" "css_element"
   Then "#ccot-light-box" "css_element" should not exist
