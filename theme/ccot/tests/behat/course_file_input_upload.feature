...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can upload files as resources directly to the current
  ...
  Scenario: In read mode, teacher uploads file.
    ...
    And ".ccot-resource[data-type='mp3']" "css_element" should exist
    ...
    And I should see "testgif" in the "#section-1 .ccot-native-image .activityinstance .instancename" "css_element"
  ...
  Scenario: Student cannot upload file.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then "#ccot-drop-file" "css_element" should not exist
