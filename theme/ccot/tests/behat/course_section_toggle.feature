...
@theme @theme_ccot
Feature: When the moodle theme is set to ccot, teachers can toggle the visibility of course sections in read mode and
  edit mode.
  ...
  Scenario: In read mode, teacher hides section.
    ...
    And "#chapters li:nth-of-type(3).ccot-visible-section" "css_element" should exist
    And "#section-2.hidden" "css_element" should not exist
    And I click on "#section-2 .ccot-visibility.ccot-hide" "css_element"
    And I wait until "#section-2 .ccot-visibility.ccot-show" "css_element" exists
    ...
    Given I click on "#section-2 .ccot-visibility.ccot-show" "css_element"
    And I wait until "#section-2 .ccot-visibility.ccot-hide" "css_element" exists
  ...
  hide section.
    ...
    And I click on "#section-1 .ccot-visibility.ccot-hide" "css_element"
  ...
  Scenario: In read mode, student cannot hide section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 2"
    Then "#section-2 .ccot-visibility" "css_element" should not exist
