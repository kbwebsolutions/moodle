 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ccot_recent_forum_activity_test extends \advanced_testcase {
    ...
    public function test_forum_high_volume_posts($ftype = 'forum') {
        ...
        if (get_class($this) === "theme_ccot\\tests\\theme_ccot_recent_forum_activity_test") {
