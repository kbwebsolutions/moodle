 ...
 */
class theme_ccot_services_course_test extends \advanced_testcase {
    ...
    public function test_course_toc() {
        ...
        $this->assertTrue($toc->modules[0] instanceof theme_ccot\renderables\course_toc_module);
        $this->assertTrue($toc->modules[0]->url === '#section-0&module-'.$page->cmid);
        $this->assertTrue($toc instanceof theme_ccot\renderables\course_toc);
    ...
    public function test_course_toc_chapters() {
        ...
        $this->assertTrue($chapters->chapters[0] instanceof theme_ccot\renderables\course_toc_chapter);
    }
    ...
    public function test_course_toc_chapters_escaped_chars() {
        ...
        $tochtml = $OUTPUT->render_from_template('theme_ccot/course_toc_chapters',
    ...
    public function test_highlight_section() {
        ...
        $toc = $highlight['toc'];
        $this->assertTrue($actionmodel instanceof theme_ccot\renderables\course_action_section_highlight);
        $this->assertTrue($toc instanceof theme_ccot\renderables\course_toc);
    ...
    public function test_set_section_visibility() {
        ...
        $toc = $visibility['toc'];
        $this->assertTrue($actionmodel instanceof theme_ccot\renderables\course_action_section_visibility);
        $this->assertTrue($toc instanceof theme_ccot\renderables\course_toc);

        // Check that action model has toggled after section hidden.
        $this->assertEquals('ccot-visibility ccot-show', $actionmodel->class);
        ...
        // Check that action model now corresponds to unhighlighted state.
        $this->assertEquals('ccot-visibility ccot-hide', $actionmodel->class);
    ...
    public function test_user_deletion() {
        ...
        $service->setfavorite($this->courses[0]->shortname, true, $this->user1->id);
        $service->setfavorite($this->courses[1]->shortname, true, $this->user1->id);
        $favorites = $DB->get_records('theme_ccot_course_favorites', array('userid' => $this->user1->id));
