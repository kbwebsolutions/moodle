 ...
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'theme_ccot/ajax_notification'],
    function($, ajax, notification, templates, ajaxNotify) {
        ...
        var init = function(courseConfig) {
            ...
            $(document).on("ccotModuleCompletionChange",
                function() {
                    ajax.call([
                        {
                            methodname: 'theme_ccot_course_completion',
                            args: {
