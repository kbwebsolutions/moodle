...
/**
 * @module theme_ccot/dndupload-lazy
 */
define(['jquery', 'core/yui', 'theme_ccot/util'],
    function($, YUI, util) {
        var self = this;
        ...
        self.decorateCourseDNDUpload = function(Y, options) {
            ...
            /* global themeccotCourseFileHandlers */
            if (themeccotCourseFileHandlers) {
                options.handlers = themeccotCourseFileHandlers;
            } else {
                options.handlers = {};
            }
            ...
            $('.js-ccot-drop-file').change(function() {
                var sectionnumber = $(this).attr('id').replace('ccot-drop-file-', '');
