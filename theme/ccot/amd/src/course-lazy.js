...
define(
    [
        'jquery',
        'theme_ccot/util',
        'theme_ccot/section_asset_management',
        'theme_ccot/course_modules'
    ],
    ...
    return function(courseConfig) {
        ...
        this.setTOCVisibleSection = function() {
            var sectionIdSel = '.section.main.state-visible, #coursetools.state-visible, #ccot-add-new-section.state-visible';
            var currentSectionId = $(sectionIdSel).attr('id');
            $('#chapters li').removeClass('ccot-visible-section');
            $('#chapters a[href$="' + currentSectionId + '"]').parent('li').addClass('ccot-visible-section');
        ...
        this.showSection = function() {
            ...
            if ($('.section.main.state-visible.set-by-server').length) {
                ...
                $('.course-content .section.main, #moodle-blocks,#coursetools, #ccot-add-new-section').removeClass('state-visible');
            }
            ...
            var visibleChapters = $(
                ...
                '#ccot-add-new-section.state-visible'
            );
            ...
            $('li.ccot-activity:visible, li.ccot-resource:visible').on('click', 'a.mod-link', function() {
        ...
        var init = function() {
            ...
            if (self.courseConfig.enablecompletion) {
                require(
                    [
                        'theme_ccot/course_conditionals-lazy'
            ...
            if (onCoursePage()) {
                self.showSection();
                $(document).on('ccotTOCReplaced', function() {
        ...
        /**
         * ccot modchooser listener to add current section to urls.
         */
        var modchooserSectionLinks = function() {
            $('.section-modchooser-link').click(function() {
                ...
                $('.ccot-modchooser-addlink').each(function() {
