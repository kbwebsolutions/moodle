        ...
        var FooterAlert = function() {
            ...
            (function() {
                ...
                if (containerEl.length === 0) {
                    templates.render('theme_ccot/footer_alert', {})
            ...
            this.setTitle = function(titleHTML) {
                $('.ccot-footer-alert-title').html(titleHTML);
                this.setSrNotice('');
            ...
            this.addAjaxLoading = function(str) {
                str = !str ? M.util.get_string('loading', 'theme_ccot') : str;
                var titleEl = $('.ccot-footer-alert-title');
            ...
            this.show = function(onCancel) {
                containerEl.addClass('ccot-footer-alert-visible');
                if (typeof (onCancel) === 'function') {
                    $('.ccot-footer-alert-cancel').click(onCancel);
                    $('.ccot-footer-alert-cancel').addClass('state-visible');
                } else {
                    $('.ccot-footer-alert-cancel').removeClass('state-visible');
                }
            };
             ...
             */
            this.hide = function() {
                containerEl.removeClass('ccot-footer-alert-visible');
                $('.ccot-footer-alert-cancel').removeClass('state-visible');
            };
