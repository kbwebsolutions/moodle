 ...
 */
define(['jquery', 'core/log', 'core/templates', 'theme_ccot/pm_course_favorites',
    'theme_ccot/model_view', 'theme_ccot/ajax_notification', 'theme_ccot/util',
    'theme_ccot/appear'],
    function($, log, templates, courseFavorites, mview, ajaxNotify, util, appear) {
        ...
        var CourseCards = function() {
            ...
            this.applyCourseInfo = function(crsinfo) {
                ...
                templates.render('theme_ccot/course_cards', [])
                    .done(function() {
            ...
            this.reqCourseInfo = function(courseids) {
                ...
                $.ajax({
                    type: "GET",
                    async: true,
                    url: M.cfg.wwwroot + '/theme/ccot/rest.php?action=get_courseinfo&contextid=' + M.cfg.context,
                    data: courseiddata,
            ...
            this.applyAppearForImages = function() {
                ...
                $('#ccot-pm-courses .nav-tabs .nav-link').on('click', function() {
