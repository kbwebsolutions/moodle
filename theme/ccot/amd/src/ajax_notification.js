...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates', 'core/str', 'theme_ccot/util'],
        ...
        return {
            ...
            ifErrorShowBestMsg: function(response, failAction, failMsg) {
                ...
                if (response.error || response.errorcode) {
                    ...
                    if (M.ccotTheme.forcePassChange) {
                        ...
                        if ($('#ccot-pm-content').length) {
                            str.get_string('forcepwdwarningpersonalmenu', 'theme_ccot', pwdChangeUrl).then(
                                ...
                                function(result) {
                                    $('#ccot-pm-content').html('<br />' + result);
                                    dfd.resolve(true);
                                }
                            );
                            if ($('#ccot-pm-content').is(':visible')) {
                    ...
                    return $.ajax({
                        ...
                        url: M.cfg.wwwroot + '/theme/ccot/rest.php?action=get_loginstatus'
