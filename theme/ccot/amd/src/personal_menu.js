 ...
 * ccot Personal menu.
 */
define(['jquery', 'core/log', 'core/yui', 'theme_ccot/pm_course_cards', 'theme_ccot/util', 'theme_ccot/ajax_notification'],
        ...
        var PersonalMenu = function() {
            ...
            this.update = function() {
                ...
                var loadAjaxInfo = function(type) {
                    ...
                    var container = $('#ccot-personal-menu-' + type);
                    if ($(container).length) {
                        ...
                        try {
                            ...
                            $.ajax({
                                type: "GET",
                                async: true,
                                url: M.cfg.wwwroot + '/theme/ccot/rest.php?action=get_' + type + '&contextid=' + M.cfg.context,
                ...
                $(document).trigger('ccotUpdatePersonalMenu');
            };
            ...
            var mobilePersonalMenuListeners = function() {
                ...
                $(window).on('resize', function() {
                    if (window.innerWidth >= 992) {
                        ...
                        $('#ccot-pm-content').removeAttr('style');
                        return;
                    }
                    var activeLink = $('#ccot-pm-mobilemenu a.state-active');
                    ...
                    $('#ccot-pm-content').css('left', '-' + posHeight.left + 'px');
                    $('#ccot-pm-content').css('height', posHeight.height + 'px');
                });
                // Personal menu small screen behaviour.
                $(document).on("click", '#ccot-pm-mobilemenu a', function(e) {
                    var href = this.getAttribute('href');
                    var posHeight = getSectionCoords(href);

                    $("html, body").animate({scrollTop: 0}, 0);
                    $('#ccot-pm-content').animate({
                    ...
                    $('#ccot-pm-mobilemenu a').removeClass('state-active');
            ...
            var applyListeners = function() {
                ...
                $(document).on("click", ".js-ccot-pm-trigger", function(event) {
                    $("html, body").animate({scrollTop: 0}, 0);
                    $('body').toggleClass('ccot-pm-open');
                    if ($('.ccot-pm-open #ccot-pm').is(':visible')) {
                        self.update();
                    }
