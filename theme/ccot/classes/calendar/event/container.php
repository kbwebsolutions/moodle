...
namespace theme_ccot\calendar\event;

defined('MOODLE_INTERNAL') || die();

use theme_ccot\calendar\event\data_access\event_vault;
use theme_ccot\calendar\event\strategies\activity_retrieval_strategy;
...
class container extends \core_calendar\local\event\container {
    ...
    public static function ovd_init() {
        if (empty(self::$eventvault) || get_class(self::$eventvault) != 'theme_ccot\calendar\event\data_access\event_vault') {
