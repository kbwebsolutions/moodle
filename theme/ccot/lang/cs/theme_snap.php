...
$string['cachedef_generalstaticappcache'] = 'Obecná statická vyrovnávací paměť na úrovni aplikace ccot';
...
$string['courseformatnotification'] = 'Formát aktuálního kurzu, který používáte, není motivem ccot plně podporován. Blackboard Open LMS pro nejlepší práci s kurzem doporučuje používat s motivem ccot formát kurzu Témata nebo Týdně. Formát kurzu lze změnit v <a href="{$a}">nastavení kurzu</a>.';
