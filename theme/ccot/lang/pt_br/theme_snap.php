...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Dividir</h2><img class=img-polaroid src="ccot/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'O formato de curso que você está usando atualmente não é totalmente suportado pelo tema ccot. Para a melhor experiência, a Blackboard Open LMS recomenda utilizar os formatos de curso Tópicos ou Semanal com o tema ccot. O formato do curso pode ser alterado nas <a href="{$a}">configurações do curso</a>.';
