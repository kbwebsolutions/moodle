...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Fastgør</h2><img class=img-polaroid src="ccot/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Det aktuelle kursusformat, som du bruger, understøttes ikke fuldt af ccot-temaet. For at få den bedst oplevelse anbefaler Blackboard Open LMS at bruge kursusformaterne Emner eller Ugentligt sammen med ccot-temaet. Kursusformatet kan ændres i <a href="{$a}">kursusindstillinger</a>.';
