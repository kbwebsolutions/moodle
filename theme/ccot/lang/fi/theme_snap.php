...
$string['cachedef_generalstaticappcache'] = 'ccotin yleinen kiinteä sovellustason välimuisti';
...
$string['courseformatnotification'] = 'Nykyinen kurssimuoto ei täysin tue ccot-teemaa. Parhaan mahdollisen käyttökokemuksen varmistamiseksi Blackboard Open LMS suosittelee Aiheet- tai Viikoittain-kurssimuodon käyttämistä ccot-teeman kanssa. Kurssimuotoa voi vaihtaa <a href="{$a}">kurssin asetuksissa</a>.';
