...
$string['cachedef_generalstaticappcache'] = 'Memoria caché en el nivel de aplicación estática general ccot';
...
$string['courseformatnotification'] = 'El formato actual del curso que está usando no es completamente compatible con el tema de ccot. Para obtener la mejor experiencia, Blackboard Open LMS recomienda usar los formatos de cursos Temas o Semanalmente con el tema de ccot. El formato del curso se puede cambiar en los <a href="{$a}">ajustes del curso</a>.';
