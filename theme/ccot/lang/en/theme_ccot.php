...
$string['cachedef_generalstaticappcache'] = 'ccot general static application level cache';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>ccot</h2><img class=img-polaroid src="ccot/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the ccot theme. For the best experience Blackboard Open LMS recommends using the Topics or Weekly course formats with the ccot theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['copywrite'] = '© 2018 Accelerate Teaching Programme.';
...
$string['poweredbyrunby'] = 'CCOT theme developed by Kieran Briggs for the Chartered College of Teaching<br />based on Snap from Moodlerooms';
...
$string['privacy:metadata:theme_ccot_course_favorites:timefavorited'] = 'The timestamp of when the user favorited the course';
$string['privacy:metadata:theme_ccot_course_favorites'] = 'Stores users\' course favorites for ccot';
...
$string['showallsectionsdisabled'] = 'Due to its design language, "Show all sections on one page" isn\'t available in ccot.';
$string['disabled'] = 'Disabled';
$string['showappearancedisabled'] = 'ccot\'s design language prevents changes to "Appearance" settings.';
