...
$string['courseformatnotification'] = '現在お使いのコース形式はccot themeでは完全にサポートされていません。Blackboard Open LMSで最高のエクスペリエンスを実現するには、ccot themeのトピックまたは週次コースの形式を使用することをお勧めします。コース形式は<a href="{$a}">コース設定</a>で変更できます。';
