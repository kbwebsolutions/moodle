...
$string['cachedef_generalstaticappcache'] = 'Cache ccot statique général au niveau de l\'application';
...
$string['courseformatnotification'] = 'Le format de cours que vous utilisez actuellement n\'est pas totalement pris en charge par le thème ccot. Blackboard Open LMS recommande d\'utiliser les formats de cours Hebdomadaire et Rubrique avec le thème ccot pour bénéficier de la meilleure expérience. Le format de cours peut être modifié dans les <a href="{$a}">réglages du cours</a>.';
