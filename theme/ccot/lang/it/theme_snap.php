...
$string['cachedef_generalstaticappcache'] = 'Cache livello applicazione statica generale ccot';
...
$string['courseformatnotification'] = 'Il formato del corso corrente che si sta utilizzando non è completamente supportato dal tema ccot. Per ottimizzare l\'esperienza, Blackboard Open LMS consiglia di utilizzare i formati del corso Argomenti o Settimanale con il tema ccot. Il formato del corso può essere modificato nelle <a href="{$a}">impostazioni del corso</a>.';
