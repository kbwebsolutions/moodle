...
class featured_courses implements \renderable, \templatable {
    ...
    public function __construct() {
        ...
        if ($PAGE->user_is_editing()) {
            $url = new moodle_url('/admin/settings.php?section=themesettingmypd#thememypdfeaturedcourses');
            $this->editurl = $url;
        }
        ...
        foreach ($orderedcourses as $course) {
            ...
            $this->cards[] = new featured_course($url, $coverimageurl, $course->fullname, $course->summary, $i, $this->colclass);
        }
    }
}
