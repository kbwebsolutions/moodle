...
namespace theme_mypd\webservice;
    ...
    public static function service_returns() {
        $keys = [
            'actionmodel' => new \external_single_structure(
                definition_helper::define_class_for_webservice('theme_mypd\renderables\course_action_section_base'),
                'Action model',
                VALUE_OPTIONAL
            ),
            'toc' => new \external_single_Structure(
                definition_helper::define_class_for_webservice('theme_mypd\renderables\course_toc'),
                'Table of contents',
                VALUE_REQUIRED
            )
        ];
