...
use theme_mypd\webservice\definition_helper;
 ...
 */
class theme_mypd_webservice_definition_helper_test extends advanced_testcase {
...
EOF;
    ...
    public function test_cache_definition() {
        ...
        $cache = cache::make('theme_mypd', 'webservicedefinitions');
