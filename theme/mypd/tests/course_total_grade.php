...
use theme_mypd\course_total_grade;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_mypd_course_total_grade_test extends \advanced_testcase {
    ...
    public function test_performance() {
        ...
        $newtime = $this->run_performance_test($title, 'theme_mypd\local::course_grade', []);
