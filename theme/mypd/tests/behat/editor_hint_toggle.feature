@theme @theme_mypd
Feature: the editor hint toggle should be ignored by myPD in Blackboard Open LMS 2.9
  ...
  Background:
    Given the following config values are set as admin:
      | theme_mypd_disableeditorhints | true |
  ...
  @javascript
  Scenario: Create a URL resource in myPD theme
