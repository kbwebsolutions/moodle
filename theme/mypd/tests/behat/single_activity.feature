...
#
# Tests that Single Activity format remains usable in myPD
#
# @package   theme_mypd
# @author    Sam Chaffee
...
@theme @theme_mypd
Feature: Use the Single Activity format in myPD
  In order to use the Single Activity format in myPD
  As a teacher
  I need to be able to create a course using Single Activity format without errors in myPD
  ...
  Scenario: Admin creates a single activity course with a Glossary
    ...
    And I set the following fields to these values:
      | Course full name | Test single activity in myPD|
