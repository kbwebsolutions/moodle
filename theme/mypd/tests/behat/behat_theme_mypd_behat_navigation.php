...
/**
 * Overrides to make behat navigation work with myPD.
 *
 * @author    Guy Thomas <osdev@blackboard.com>
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_mypd_behat_navigation extends behat_navigation {
...
EOF;
    ...
    /**
     * Just go to the course page as myPD doesn't have the same concept of editing mode.
     */
    public function i_am_on_course_homepage_with_editing_mode_on($coursefullname) {
        // myPD doesn't really have the concept of edit mode.
