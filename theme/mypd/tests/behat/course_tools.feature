...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, a course tools section is available.
  ...
  Scenario Outline: Course tools link functions for supported formats.
    ...
    And "#mypd-student-dashboard" "css_element" should exist
    And ".mypd-student-dashboard-progress" "css_element" <seecompletion> exist
    And ".mypd-student-dashboard-grade" "css_element" <seegrade> exist
    Examples:
  ...
  Scenario: Grade and progress are shown to students only when allowed by settings.
    ...
    And I am on the course main page for "C1"
    And I click on "a[href=\"#coursetools\"]" "css_element"
    And ".mypd-student-dashboard-progress" "css_element" should not exist
    And ".mypd-student-dashboard-grade" "css_element" should not exist
    ...
    And I am on the course main page for "C1"
    And I click on "a[href=\"#coursetools\"]" "css_element"
    And ".mypd-student-dashboard-progress" "css_element" should exist
    And ".mypd-student-dashboard-grade" "css_element" should exist
    Given the following config values are set as admin:
      | showcoursegradepersonalmenu | 0 | theme_mypd |
