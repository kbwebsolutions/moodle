...
#
# Tests for single section to be overriden with normal behaviour in myPD.
#
# @package    theme_mypd
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, courses in single section per page mode are forced to operate with all
