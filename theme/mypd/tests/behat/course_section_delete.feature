...
#
# Tests deleting sections in mypd.
#
# @package    theme_mypd
# @author     Guy Thomas
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, teachers can delete sections without having to reload the page.
  ...
  Scenario: In read mode, on course, teacher can cancel / confirm delete section.
    ...
    When I click on "#section-1 .mypd-section-editing.actions a.mypd-delete" "css_element"
  ...
  Scenario: Student cannot delete section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then "#section-1 .mypd-section-editing.actions a.mypd-delete" "css_element" should not exist
