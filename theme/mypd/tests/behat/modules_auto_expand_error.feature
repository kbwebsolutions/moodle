...
@theme @theme_mypd
Feature: When setting an erroneous field in settings, mypd auto-expands area.
  ...
  Scenario: Go to Assignment settings page and put wrong max grade.
    ...
    And I click on ".mypd-activity[data-type='Assignment']  a.mypd-edit-asset" "css_element"
