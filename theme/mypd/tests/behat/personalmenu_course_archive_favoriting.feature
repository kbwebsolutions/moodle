...
#
# Tests for course favoriting in the myPD personal menu.
#
# @package    theme_mypd
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, expired courses appear in an archive section within the personal menu.
  ...
  Scenario: User can navigate to and from archived courses sections.
    ...
    And I click on "#mypd-pm-tab-current" "css_element"
    And I should not see "Past-course 1"
    And I should not see "Past-course 2"
    And I should not see "Past-course 3"
