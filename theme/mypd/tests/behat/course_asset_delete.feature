...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, teachers can delete course resources and activities without having to reload the page.
  ...
  Scenario: In read mode, on front page, admin can cancel / confirm delete activity.
    ...
    When I click on ".mypd-activity[data-type='Assignment'] span.mypd-edit-asset-more" "css_element"
    And I click on ".mypd-activity[data-type='Assignment'] a.js_mypd_delete" "css_element"
  ...
  Scenario: Student cannot delete activity.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then ".mypd-activity[data-type='Assignment'] span.mypd-edit-asset-more" "css_element" should not exist
    And ".mypd-activity[data-type='Assignment'] a.js_mypd_delete" "css_element" should not exist
