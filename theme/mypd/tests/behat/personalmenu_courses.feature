...
#
# Tests for courses in the myPD personal menu.
#
# @package    theme_mypd
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, students and teachers can open a personal menu with a list of courses
