...
#
# Tests for myPD personal menu on mobile devices.
#
# @package    theme_mypd
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, students and teachers can open a personal menu which works responsively
  on mobile devices.
  ...
  Scenario Outline: Teacher / Student can view personal menu on a mobile device.
    ...
    And I click on "#mypd-pm-close" "css_element"
    And I open the personal menu
    And I wait until "#mypd-pm-mobilemenu" "css_element" is visible
  ...
  Scenario Outline: Mobile menu icons only appear when enabled.
    ...
    Examples:
    | toggle           | href                           |
    | deadlinestoggle  | #mypd-personal-menu-deadlines  |
    | feedbacktoggle   | #mypd-personal-menu-graded     |
    | messagestoggle   | #mypd-personal-menu-messages   |
    | forumpoststoggle | #mypd-personal-menu-forumposts |
