...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, clicking on a resource with a media file mime type will open the
  resource inline.
  ...
  Scenario: MP3 opens inline and marked as completed.
    ...
    Then ".mypd-resource[data-type='mp3']" "css_element" should exist
    And I click on ".mypd-edit-asset" "css_element"
    ...
    And I click on ".mypd-resource[data-type='mp3'] .mypd-asset-link a" "css_element"
    And I wait until "#mypd-light-box" "css_element" is visible
   Then "#mypd-light-box" "css_element" should exist
    And I click on "#mypd-light-box-close" "css_element"
   Then "#mypd-light-box" "css_element" should not exist
  ...
  Scenario: MP3 opens inline with its description.
    ...
    And I set the following fields to these values:
      ...
      | showdescription                                | 1                   |
    And I click on "#id_submitbutton2" "css_element"
    And I click on ".mypd-extended-resource[data-type='mp3'] .mypd-asset-link a" "css_element"
    And I wait until "#mypd-light-box" "css_element" is visible
    Then "#mypd-light-box" "css_element" should exist
