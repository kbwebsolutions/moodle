...
/**
 * Overrides to make behat course steps work with myPD.
 *
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_mypd_behat_course extends behat_course {
    ...
    public function i_add_to_section($activity, $section) {
        ...
        $xpath = "//*[@id='mypd-modchooser-modal']//a[text()='$activity']";
