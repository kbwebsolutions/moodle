...
@theme @theme_mypd @_bug_phantomjs
Feature: When the moodle theme is set to myPD, students and teachers can open a personal menu which shows a
  ...
  Scenario: 1 out of 2 assignments are submitted by student and graded by teacher.
   ...
   When I follow "Add submission"
    ...
    And I log in as "teacher1"
    And I open the personal menu
    And I wait until "#mypd-personal-menu-grading[data-content-loaded=\"1\"]" "css_element" is visible
    # The above waits until the mypd personal menu column is loaded.
   ...
   Then I should see "You have no submissions to grade."
    ...
    And I log in as "student1"
    And I open the personal menu
    And I should see "Test assignment1" in the "#mypd-personal-menu-graded" "css_element"
    And I should see "Feedback"
