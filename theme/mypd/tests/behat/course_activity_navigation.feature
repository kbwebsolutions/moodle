...
@theme @theme_mypd
Feature: Activity navigation in myPD theme
  ...
  Background:
    ...
    # Hidden activity.
    And I click on ".mypd-activity[data-type='Glossary'] span.mypd-edit-asset-more" "css_element"
    And I click on ".mypd-activity[data-type='Glossary'] a.js_mypd_hide" "css_element"
    # Hidden section.
    And I follow "Topic 5"
    And I wait until the page is ready
    And I click on "#section-5 a.mypd-visibility.mypd-hide" "css_element"
    # Set up book.
  ...
  Scenario: Resources with visible description have a different class
    ...
    And I wait until the page is ready
    And I check element ".modtype_url" has class "mypd-resource"
    And I follow "Edit \"Url 1\""
    And I expand all fieldsets
    And I set the field "Display description on course page" to "1"
    And I press "Save and return to course"
    And I check element ".modtype_url" has class "mypd-extended-resource"
