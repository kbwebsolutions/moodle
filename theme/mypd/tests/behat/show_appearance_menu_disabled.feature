...
#
# Tests for myPD on a page resource.
#
# @package    theme_mypd
...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD and there is a page resource, appearance options should not appear.
  ...
  @javascript
  Scenario: Page description checkbox is not shown when using myPD.
    Given I log in as "teacher1"
    And I am on the course main page for "C1"
    Then I click on "//a[@class='mypd-edit-asset']" "xpath_element"
  ...
  Scenario: Teacher sees a warning message and is unable to choose any appearance options on page resource.
    ...
    And I should see "myPD's design language prevents changes to \"Appearance\" settings."
