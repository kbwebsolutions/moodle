...
@theme @theme_mypd
Feature: When theme is set to myPD, and course:activityvisibility is set for students, a student should be able to
  hide an activity.
  ...
  Scenario: Student should not see the activity after hiding it
    ...
    And ".mypd-activity[data-type='Assignment'] span.mypd-edit-asset-more" "css_element" should not exist
