...
@theme @theme_mypd
Feature: When the moodle theme is set to myPD, and global search is enabled, users should see a global search interface.
  ...
  Scenario: Non-logged in user sees search interface.
    ...
    Then ".mypd-login-button" "css_element" should exist
