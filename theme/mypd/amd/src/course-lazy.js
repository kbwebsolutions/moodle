...
define(
    [
        'jquery',
        'theme_mypd/util',
        'theme_mypd/section_asset_management',
        'theme_mypd/course_modules'
    ],
    ...
    return function(courseConfig) {
        ...
        this.setTOCVisibleSection = function() {
            var sectionIdSel = '.section.main.state-visible, #coursetools.state-visible, #mypd-add-new-section.state-visible';
            var currentSectionId = $(sectionIdSel).attr('id');
            $('#chapters li').removeClass('mypd-visible-section');
            $('#chapters a[href$="' + currentSectionId + '"]').parent('li').addClass('mypd-visible-section');
        ...
        this.showSection = function() {
            ...
            if ($('.section.main.state-visible.set-by-server').length) {
                ...
                $('.course-content .section.main, #moodle-blocks,#coursetools, #mypd-add-new-section').removeClass('state-visible');
            }
            ...
            var visibleChapters = $(
                ...
                '#mypd-add-new-section.state-visible'
            );
            ...
            $('li.mypd-activity:visible, li.mypd-resource:visible').on('click', 'a.mod-link', function() {
        ...
        var init = function() {
            ...
            if (self.courseConfig.enablecompletion) {
                require(
                    [
                        'theme_mypd/course_conditionals-lazy'
            ...
            if (onCoursePage()) {
                self.showSection();
                $(document).on('mypdTOCReplaced', function() {
        ...
        /**
         * myPD modchooser listener to add current section to urls.
         */
        var modchooserSectionLinks = function() {
            $('.section-modchooser-link').click(function() {
                ...
                $('.mypd-modchooser-addlink').each(function() {
