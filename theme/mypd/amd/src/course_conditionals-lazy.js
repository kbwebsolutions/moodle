 ...
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'theme_mypd/ajax_notification'],
    function($, ajax, notification, templates, ajaxNotify) {
        ...
        var init = function(courseConfig) {
            ...
            $(document).on("mypdModuleCompletionChange",
                function() {
                    ajax.call([
                        {
                            methodname: 'theme_mypd_course_completion',
                            args: {
