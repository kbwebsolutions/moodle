        ...
        var FooterAlert = function() {
            ...
            (function() {
                ...
                if (containerEl.length === 0) {
                    templates.render('theme_mypd/footer_alert', {})
            ...
            this.setTitle = function(titleHTML) {
                $('.mypd-footer-alert-title').html(titleHTML);
                this.setSrNotice('');
            ...
            this.addAjaxLoading = function(str) {
                str = !str ? M.util.get_string('loading', 'theme_mypd') : str;
                var titleEl = $('.mypd-footer-alert-title');
            ...
            this.show = function(onCancel) {
                containerEl.addClass('mypd-footer-alert-visible');
                if (typeof (onCancel) === 'function') {
                    $('.mypd-footer-alert-cancel').click(onCancel);
                    $('.mypd-footer-alert-cancel').addClass('state-visible');
                } else {
                    $('.mypd-footer-alert-cancel').removeClass('state-visible');
                }
            };
             ...
             */
            this.hide = function() {
                containerEl.removeClass('mypd-footer-alert-visible');
                $('.mypd-footer-alert-cancel').removeClass('state-visible');
            };
