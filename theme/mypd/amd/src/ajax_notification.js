...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates', 'core/str', 'theme_mypd/util'],
        ...
        return {
            ...
            ifErrorShowBestMsg: function(response, failAction, failMsg) {
                ...
                if (response.error || response.errorcode) {
                    ...
                    if (M.mypdTheme.forcePassChange) {
                        ...
                        if ($('#mypd-pm-content').length) {
                            str.get_string('forcepwdwarningpersonalmenu', 'theme_mypd', pwdChangeUrl).then(
                                ...
                                function(result) {
                                    $('#mypd-pm-content').html('<br />' + result);
                                    dfd.resolve(true);
                                }
                            );
                            if ($('#mypd-pm-content').is(':visible')) {
                    ...
                    return $.ajax({
                        ...
                        url: M.cfg.wwwroot + '/theme/mypd/rest.php?action=get_loginstatus'
