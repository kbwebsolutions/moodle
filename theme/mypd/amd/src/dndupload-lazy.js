...
/**
 * @module theme_mypd/dndupload-lazy
 */
define(['jquery', 'core/yui', 'theme_mypd/util'],
    function($, YUI, util) {
        var self = this;
        ...
        self.decorateCourseDNDUpload = function(Y, options) {
            ...
            /* global thememyPDCourseFileHandlers */
            if (thememyPDCourseFileHandlers) {
                options.handlers = thememyPDCourseFileHandlers;
            } else {
                options.handlers = {};
            }
            ...
            $('.js-mypd-drop-file').change(function() {
                var sectionnumber = $(this).attr('id').replace('mypd-drop-file-', '');
