 ...
 */
define(['jquery', 'core/log', 'core/templates', 'theme_mypd/pm_course_favorites',
    'theme_mypd/model_view', 'theme_mypd/ajax_notification', 'theme_mypd/util',
    'theme_mypd/appear'],
    function($, log, templates, courseFavorites, mview, ajaxNotify, util, appear) {
        ...
        var CourseCards = function() {
            ...
            this.applyCourseInfo = function(crsinfo) {
                ...
                templates.render('theme_mypd/course_cards', [])
                    .done(function() {
            ...
            this.reqCourseInfo = function(courseids) {
                ...
                $.ajax({
                    type: "GET",
                    async: true,
                    url: M.cfg.wwwroot + '/theme/mypd/rest.php?action=get_courseinfo&contextid=' + M.cfg.context,
                    data: courseiddata,
            ...
            this.applyAppearForImages = function() {
                ...
                $('#mypd-pm-courses .nav-tabs .nav-link').on('click', function() {
