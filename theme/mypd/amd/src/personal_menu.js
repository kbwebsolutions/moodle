 ...
 * myPD Personal menu.
 */
define(['jquery', 'core/log', 'core/yui', 'theme_mypd/pm_course_cards', 'theme_mypd/util', 'theme_mypd/ajax_notification'],
        ...
        var PersonalMenu = function() {
            ...
            this.update = function() {
                ...
                var loadAjaxInfo = function(type) {
                    ...
                    var container = $('#mypd-personal-menu-' + type);
                    if ($(container).length) {
                        ...
                        try {
                            ...
                            $.ajax({
                                type: "GET",
                                async: true,
                                url: M.cfg.wwwroot + '/theme/mypd/rest.php?action=get_' + type + '&contextid=' + M.cfg.context,
                ...
                $(document).trigger('mypdUpdatePersonalMenu');
            };
            ...
            var mobilePersonalMenuListeners = function() {
                ...
                $(window).on('resize', function() {
                    if (window.innerWidth >= 992) {
                        ...
                        $('#mypd-pm-content').removeAttr('style');
                        return;
                    }
                    var activeLink = $('#mypd-pm-mobilemenu a.state-active');
                    ...
                    $('#mypd-pm-content').css('left', '-' + posHeight.left + 'px');
                    $('#mypd-pm-content').css('height', posHeight.height + 'px');
                });
                // Personal menu small screen behaviour.
                $(document).on("click", '#mypd-pm-mobilemenu a', function(e) {
                    var href = this.getAttribute('href');
                    var posHeight = getSectionCoords(href);

                    $("html, body").animate({scrollTop: 0}, 0);
                    $('#mypd-pm-content').animate({
                    ...
                    $('#mypd-pm-mobilemenu a').removeClass('state-active');
            ...
            var applyListeners = function() {
                ...
                $(document).on("click", ".js-mypd-pm-trigger", function(event) {
                    $("html, body").animate({scrollTop: 0}, 0);
                    $('body').toggleClass('mypd-pm-open');
                    if ($('.mypd-pm-open #mypd-pm').is(':visible')) {
                        self.update();
                    }
