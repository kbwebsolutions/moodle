...
$string['cachedef_generalstaticappcache'] = 'myPD algemene cache op statisch toepassingsniveau';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>myPD</h2><img class=img-polaroid src="mypd/pix/screenshot.jpg" />';
...
$string['courseformatnotification'] = 'Het huidige cursusformaat dat je gebruikt, wordt niet volledig ondersteund door het thema myPD. Voor de beste ervaring beveelt Blackboard Open LMS aan dat je de onderwerpen of wekelijkse cursusindelingen met het thema myPD gebruikt. Je kunt de cursusindeling wijzigen in de <a href="{$a}">cursusinstellingen</a>.';
