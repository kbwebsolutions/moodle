...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Dividir</h2><img class=img-polaroid src="mypd/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'O formato de curso que você está usando atualmente não é totalmente suportado pelo tema myPD. Para a melhor experiência, a Blackboard Open LMS recomenda utilizar os formatos de curso Tópicos ou Semanal com o tema myPD. O formato do curso pode ser alterado nas <a href="{$a}">configurações do curso</a>.';
