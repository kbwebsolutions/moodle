...
$string['cachedef_generalstaticappcache'] = 'myPDin yleinen kiinteä sovellustason välimuisti';
...
$string['courseformatnotification'] = 'Nykyinen kurssimuoto ei täysin tue myPD-teemaa. Parhaan mahdollisen käyttökokemuksen varmistamiseksi Blackboard Open LMS suosittelee Aiheet- tai Viikoittain-kurssimuodon käyttämistä myPD-teeman kanssa. Kurssimuotoa voi vaihtaa <a href="{$a}">kurssin asetuksissa</a>.';
