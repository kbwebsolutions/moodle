...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Fastgør</h2><img class=img-polaroid src="mypd/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Det aktuelle kursusformat, som du bruger, understøttes ikke fuldt af myPD-temaet. For at få den bedst oplevelse anbefaler Blackboard Open LMS at bruge kursusformaterne Emner eller Ugentligt sammen med myPD-temaet. Kursusformatet kan ændres i <a href="{$a}">kursusindstillinger</a>.';
