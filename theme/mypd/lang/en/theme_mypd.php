...
$string['cachedef_generalstaticappcache'] = 'myPD general static application level cache';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>myPD</h2><img class=img-polaroid src="mypd/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the myPD theme. For the best experience Blackboard Open LMS recommends using the Topics or Weekly course formats with the myPD theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['privacy:metadata:theme_mypd_course_favorites:courseid'] = 'The course ID of the course that the user favorited';
$string['privacy:metadata:theme_mypd_course_favorites:userid'] = 'The user ID of the user that favorited the course';
$string['privacy:metadata:theme_mypd_course_favorites:timefavorited'] = 'The timestamp of when the user favorited the course';
$string['privacy:metadata:theme_mypd_course_favorites'] = 'Stores users\' course favorites for myPD';
...
$string['showallsectionsdisabled'] = 'Due to its design language, "Show all sections on one page" isn\'t available in myPD.';
$string['disabled'] = 'Disabled';
$string['showappearancedisabled'] = 'myPD\'s design language prevents changes to "Appearance" settings.';
...
<li>The string <code>mypd-pbb-</code> will be prepended</li>
<li>This class will be added to the <code>body</code> Html tag</li></ul>
For Example, the user field value <em>Blueberry Extravaganza</em> will be slugified to be <code>mypd-pbb-blueberry-extravaganza</code><br /><br />
This feature is used in conjunction with <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/myPD#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
you\'ll need to add CSS selectors using the new classes in the <a class="mypd-settings-tab-link" href="#thememypdbranding">Basics</a> section.';
...
$string['pbb_field_description'] = 'This field\'s value will be slugified and used as a CSS class name prepended by <code>mypd-pbb-</code>.';
