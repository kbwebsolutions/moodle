...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Wykonaj migawkę</h2><img class=img-polaroid src="mypd/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Aktualnie używany format kursu nie jest w pełni obsługiwany przez kompozycję myPD. W celu uzyskania najlepszych rezultatów Blackboard Open LMS zaleca stosowanie z kompozycją myPD formatów kursu Tematy lub Tygodniowy. Format kursu można zmienić w <a href="{$a}">ustawieniach kursu</a>.';
