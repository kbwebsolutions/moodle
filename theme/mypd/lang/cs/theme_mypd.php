...
$string['cachedef_generalstaticappcache'] = 'Obecná statická vyrovnávací paměť na úrovni aplikace myPD';
...
$string['courseformatnotification'] = 'Formát aktuálního kurzu, který používáte, není motivem myPD plně podporován. Blackboard Open LMS pro nejlepší práci s kurzem doporučuje používat s motivem myPD formát kurzu Témata nebo Týdně. Formát kurzu lze změnit v <a href="{$a}">nastavení kurzu</a>.';
