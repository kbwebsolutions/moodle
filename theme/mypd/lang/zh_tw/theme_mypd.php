...
$string['cachedef_generalstaticappcache'] = 'myPD 一般靜態應用程式層級快取';
...
$string['courseformatnotification'] = 'myPD 主題無法完整支援您目前使用的課程格式。為了享有最佳使用體驗，Blackboard Open LMS 建議您針對 myPD 主題使用「主題」或「每週」課程格式。您可以在「<a href="{$a}">課程設定</a>」中變更課程格式。';
