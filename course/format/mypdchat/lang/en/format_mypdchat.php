...
/**
 * Strings for component 'format_mypdchat', language 'en'
 *
...
$string['cachedef_attachedrecentactivities'] = 'mypdchat:Attached recent activities';
$string['cachedef_commentformerrors'] = 'mypdchat:Comment form errors';
$string['cachedef_postformerrors'] = 'mypdchat:Post form errors';
$string['cachedef_postformparams'] = 'mypdchat:Post form params';
$string['cachedef_timelinefilter'] = 'mypdchat:Timeline filter';
...
$string['page-course-view-mypdchat'] = 'Any course main page in mypdchat format';
$string['page-course-view-mypdchat-x'] = 'Any course page in mypdchat format';
$string['pluginname'] = 'MyPD Chat format';
...
$string['showalldicussions'] = 'All Comments';
$string['showallposts'] = 'Reset filter to show all posts';
$string['showallreplies'] = 'Show all replies ({$a} more)';
$string['showfromothers'] = 'Show topic';
$string['mypdchat:like'] = 'Create likes';
$string['mypdchat:lockcomment'] = 'Lock comments';
$string['mypdchat:makesticky'] = 'Make sticky';
$string['mypdchat:deleteanypost'] = 'Delete all users posts';
$string['mypdchat:deleteownpost'] = 'Delete own posts';
$string['mypdchat:deleteanycomment'] = 'Delete others users comments';
$string['mypdchat:deleteowncomment'] = 'Delete own comments';
$string['mypdchat:postprivate'] = 'Do private posts';
$string['mypdchat:posturl'] = 'Post url (module)';
$string['mypdchat:postfile'] = 'Post file (module)';
$string['mypdchat:posthtml'] = 'Post HTML text';
$string['mypdchat:viewprivate'] = 'View private posts';
$string['mypdchat:viewlikes'] = 'View number of likes';
$string['mypdchat:writecomment'] = 'Write comment';
$string['mypdchat:updateownpost'] = 'Update own post';
$string['mypdchat:updateanypost'] = 'Update any post';
