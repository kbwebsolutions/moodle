...
class queries {
    ...
    public function get_participant_numbers(){
        ...
        $sql = "SELECT DISTINCT c.id, c.fullname,
                    (SELECT COUNT( ra.userid ) AS Users FROM {role_assignments} AS ra JOIN {context} AS ctx ON ra.contextid = ctx.id WHERE ra.roleid = :student AND ctx.instanceid = c.id ) AS Participants,
