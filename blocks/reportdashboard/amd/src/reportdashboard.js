        ...
        return {
            init: function() {
                    ...
                    $(".dashboard").change(function(){
                        ...
                        $(".report_categories").val(categoryid);
                ...
                */
                $(document).on('click',".filterform #id_filter_clear",function(e) {
                    ...
                    var activityelement = $(this).parents('.mform').find('#id_filter_activity');
                ...
                $(document).on('change', "select[name='filter_courses']", function(){
                    ...
                    var activityelement = $(this).closest('.mform').find('#id_filter_activity');
                    ...
                    if(userelement.length != 0){
                        smartfilter.EnrolledUsers({ courseid: courseid ,element: userelement});
                    }
                });
            ...
            addblocks_to_dashboard: function() {
                Str.get_string('addblockstodashboard','block_reportdashboard'
                    ...
                    $('.reportslist').dialog({
                        ...
                        maxHeight: 600,
                        position: {
                            within: '#licenceresult'
                        }
                    });
                    $('.reportslist').closest(".ui-dialog")
                        .find(".ui-dialog-titlebar-close")
                        .removeClass("ui-dialog-titlebar-close")
                        .html("<span class='ui-button-icon-primary ui-icon ui-icon-closethick' title='Close'></span>");
            ...
            reportfilter: function(args) {
                ...
                if ($('.report_filter_' + args.instanceid).length < 1) {
                    ...
                    promise[0].done(function(resp) {
                        ...
                        // $("select[data-select2='1']").select2();
                        $("select[data-select2='1']").each(function() {
                    ...
                    $(".report_filter_" + args.instanceid).dialog({
                        ...
                        $(".report_filter_" + args.instanceid + " form  #id_filter_apply").click(function(e) {
                            ...
                            if ($("#reportcontainer" + args.instanceid).html().length > 0 ) {
                                args.singleplot = $("#reportcontainer" + args.instanceid).data('reporttype');
                            } else {
                                args.singleplot = $("#plotreportcontainer" + args.instanceid).data('reporttype');
                            }
