define(['jquery',
    ...
    function($, ajax, AjaxForms, Str, ModalFactory, ModalEvents, Ajax, notification) {
        return helper = {
                    ...
                    ModalFactory.create({
                        ...
                        modal.getRoot().on(ModalEvents.save, function(e) {
                            ...
                            promise[0].done(function(resp) {
                                if(resp.disabledelete){
                                    helper.notifications(s[3], 'danger');
                                }else{
                                    ...
                                    if (activetabid === args.cid && $( "#report_plottabs li:eq(0) a" ).length > 0) {
                                        $( "#report_plottabs li:eq(0) a" ).trigger('click');
                                    } else if ($( "#report_plottabs li:eq(0) a" ).length < 1) {
            ...
            Select2Ajax: function(args) {
                $("select[data-select2-ajax='1']").each(function() {
                    ...
                    var categoryid = $('.dashboard').find(":selected").val();
