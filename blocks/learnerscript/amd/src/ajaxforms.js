...
define(['jquery',
    ...
    function($, Str, ModalFactory, ModalEvents, Fragment, Ajax, schedule, Y, Templates, Modal, helper) {
        ...
        AjaxForms.prototype.init = function(args) {
            ...
            resp.done(function(data) {
                ...
                if (args.action == 'plotforms' && (args.pname == 'bar' || args.pname == 'column' || args.pname == 'line')) {
                        ...
                        Str.get_strings([{
                            ...
                            if (self.args.type == 'add') {
                                ...
                                Templates.render(templatename, tabdata).done(function(tab) {
                                    ...
                                    if ($('#report_plottabs').length > 0) {
                                        $("div#report_plottabs ul").append(tab);
                                    } else {
                                        $("div#reportbox_shadow").after(tab);
                                    }
