    ...
    function($, Ajax, Highcharts, smartfilter, report) {
        ...
        return chart = {
            ...
            lbchart: function(chartdata) {
                ...
                var chartcolors = ['#2f7ed8', '#0d233a', '#8bbc21', '#910000', '#1aadce', '#492970', '#f28f43', '#77a1e5', '#c42525', '#a6c96a'];
                ...
                var chart = Highcharts.chart(chartdata.containerid, {
                    ...
                    tooltip: {
                        ...
                        pointFormat: '<tr>' +
                            '<td style="padding:0">{series.name}</td><td> <b>{point.y}</b></td></tr>',
                        footerFormat: '</table>',
                        shared: true,
                        useHTML: true
                    },
