...
if (!$download) {
	...
	if (has_capability('block/learnerscript:managereports', $context) ||
		...
		$managereporturl = new moodle_url($CFG->wwwroot . '/blocks/learnerscript/managereport.php', array('courseid' => $report->courseid));
		$PAGE->navbar->add(get_string('managereports', 'block_learnerscript'), $managereporturl);
	} else {
		$dashboardurl = new moodle_url($CFG->wwwroot . '/blocks/reportdashboard/dashboard.php', array());
