...
$PAGE->set_url('/blocks/learnerscript/managereport.php', array('courseid' => $course->id));
...
if ($reports) {
    ...
    foreach ($reports as $r) {
        if ($r->courseid == 1) {
            ...
            $coursename = '<a href="' . $CFG->wwwroot . '/blocks/learnerscript/managereport.php?courseid=' . $r->courseid . '">' . $coursename . '</a>';
        }
