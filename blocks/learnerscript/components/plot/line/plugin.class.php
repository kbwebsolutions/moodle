...
class plugin_line extends pluginbase {
    ...
    function init() {
        ...
        $this->form = true;
        $this->ordering = true;
        $this->reporttypes = array('timeline', 'sql', 'assignment', 'badges',
                            'courseactivities', 'courseparticipation', 'courses', 'coursesoverview',
                            'gradedactivity', 'grades', 'myassignments', 'myquizs', 'myresources',
                            'quizzes', 'scorm', 'student_overall_performance', 
                            'student_performance', 'useractivities', 'userassignments',
                            'usercourses', 'userquizzes', 'usersresources', 'usersscorm');
    }
