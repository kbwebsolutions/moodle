...
$string['report_coursewisetimespent'] = 'Course wise User timespent';
...
$string['coursewisetimespentcolumns'] = 'Course wise User timespent Columns';
...
$string['report_coursewisetimespent_help'] = '<p><strong>Description: </strong>This report helps the user to know the timespent by the Learner in site level using the columns like firstaccess, lastaccess and total timespent.</p><table class = "help_icon_table" border="1"><tbody><tr><th><p><strong>Columns</strong></p></th><th><p><strong>Description</strong></p></th></tr><tr><td><p>Learner</p></td><td><p>List of learner fields like full name, email etc…</p></td></tr><tr><td><p>Firstaccess</p></td><td><p>Time accessed by learner for the first time in site level</p></td></tr><tr><td><p>Lastaccess</p></td><td><p>Time accessed by learner for the last time in site level</p></td></tr><tr><td><p>Total Timespent</p></td><td><p>Total timespent by the learner</p></td></tr></tbody></table>';
