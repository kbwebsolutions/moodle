...
$managereporturl = new moodle_url($CFG->wwwroot . '/blocks/learnerscript/managereport.php', $params);
...
if (($show || $hide) && confirm_sesskey()) {
	...
	header("Location: $CFG->wwwroot/blocks/learnerscript/managereport.php?courseid=$courseid");
	die;
}
...
if ($editform->is_cancelled()) {
	if (!empty($report)) {
		...
		redirect($CFG->wwwroot . '/blocks/learnerscript/managereport.php?courseid=' . $courseid);
	}
